    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-dark py-4 sm:py-8 px-4 transition-colors duration-500">
        <div className="max-w-2xl mx-auto">
          <button
            onClick={onBack}
            className="inline-flex items-center gap-2 px-4 py-2 mb-6 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-dark-50 border border-gray-200 dark:border-dark-100 rounded-lg hover:bg-gray-50 dark:hover:bg-dark-100 hover:shadow-md transition-all"
          >
